...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_FAERIE_DRAGON,   SK_SHORT_BLADES,   -1),
    APT(SP_FAERIE_DRAGON,   SK_LONG_BLADES,    -2),
    APT(SP_FAERIE_DRAGON,   SK_AXES,           -3),
    APT(SP_FAERIE_DRAGON,   SK_MACES_FLAILS,   -1),
    APT(SP_FAERIE_DRAGON,   SK_POLEARMS,       -3),
    APT(SP_FAERIE_DRAGON,   SK_STAVES,         -2),
    APT(SP_FAERIE_DRAGON,   SK_SLINGS,         -1),
    ...
    APT(SP_FAERIE_DRAGON,   SK_TRANSMUTATIONS, -1),
    APT(SP_FAERIE_DRAGON,   SK_FIRE_MAGIC,      2),
    APT(SP_FAERIE_DRAGON,   SK_ICE_MAGIC,       2),
    APT(SP_FAERIE_DRAGON,   SK_AIR_MAGIC,       2),
    APT(SP_FAERIE_DRAGON,   SK_EARTH_MAGIC,     1),
    APT(SP_FAERIE_DRAGON,   SK_POISON_MAGIC,    1),
